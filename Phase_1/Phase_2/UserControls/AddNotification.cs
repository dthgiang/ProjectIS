...
namespace Phase_1.UserControls
{
    public partial class AddNotification : UserControl
    {
        ...
        public void sendNotificationButton_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                OracleCommand command = new OracleCommand(DatabaseAccess.Connector.getOLSAdmin() + ".assignDataLabel", connection);
        ...
        private void assignButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                OracleCommand command = new OracleCommand(DatabaseAccess.Connector.getOLSAdmin() + ".assignUserLabel", connection);
                // set the command type to stored procedure
                command.CommandType = CommandType.StoredProcedure;
